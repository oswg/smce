...
I'll probably be excerpting a bit more this week from this session, as it's long and features several distinct questions with reasonably short, cogent answers. But it's now about 18 months out from first contact with the Ra complex; can you feel the group consolidating in their seeking? Even the more transient questions have gotten much more focused, and the core concepts are getting more definition.
...
In other words, this sense of free will is precisely what being a Creator is like at _this_ level of distortion in the all-self. Which level of distortion? That's easy: the one you entertain as you read this. As Ra said, it's not actually a _necessary_ distortion; it's chosen as an alternative to choicelessness. 
...
sounds a lot like [the introduction to _A Course in Miracles_](https://acim.org/acim/en/s/51#1:1-5):
...
It's because I studied ACIM that the paradox of free will never bothered me that much. Infinity allows for sufficient time for [the proverbial monkey to write Shakespeare](https://en.wikipedia.org/wiki/Infinite_monkey_theorem). So our experience in incarnation can be understood as ways we lengthen or contract the inevitability of reunification so as to gain or lose confusion. In fact, that's also a way to understand polarity (see [the end of this Hatonn transcript](https://www.llresearch.org/channeling/1978/0809)), but now I'm just digressing. Let's get back to the main event:
